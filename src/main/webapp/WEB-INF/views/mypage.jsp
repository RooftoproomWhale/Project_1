...
.content-one ul li:not (:last-child ){
	padding-bottom: 2px;
...
.homeFaqSec .faqBest5 li h4 {
	font-weight: normal;
}

.homeFaqSec .faqBest5 li h4 a {
	position: absolute;
	z-index: 100;
	display: block;
	top: 0;
...
.homeFaqSec .faqBest5 li.on h4 a {
	font-weight: bold;
	color: #6f81f3;
	background: url(https://ssl.nx.com/S2/membership/2011/home/bg_faqon.gif)
		no-repeat right top;
}

.homeFaqSec .faqBest5 .faqList1 h4 a {
	top: 51px;
}

.homeFaqSec .faqBest5 .faqList2 h4 a {
	top: 75px;
}
...
.faqBest5List {
	...
	height: 163px;
	padding-left: 23px;
	background: url(https://ssl.nx.com/S2/membership/2011/home/bg_faq.gif)
		no-repeat left top;
}
...
.faqBest5List ol li:hover span {
	background-color: #787878;
}

.faqBest5List ol a:hover {
	color: #333333;
}
		...
		<div class="page content col-md-8"
			...
			<div class='content-to col-md-offset-1 col-md-5'>
				...
				<ul class="list-unstyled2" style="height: 100%">
					...
					<li><input type="text" value='010-1234-5678'
						style="width: 50%; margin-right: 0px; padding-right: 0px" /><input
						style="width: 50%; height: 34px; margin-left: 0px; padding-left: 0px; border: 3px white solid;"
						class="btn-info" type="button" value="빠른예약 신청"></li>
					<li><input class="btn btn-info" style="width: 100%"
						type="button" value="온라인 예약" /></li>
					<li><h4>
							<span class="glyphicon glyphicon-phone-alt"> </span>&nbsp;전화문의
							1588-1588
						</h4>
				</ul>
			</div>
			...
			<div class='content-to col-md-offset-1 col-md-5'>
				...
				<ul class="list-unstyled4" style="height: 100%">
					<li><input class="btn btn-info" style="width: 100%"
						type="button" value='병원 찾기' onclick=""></li>
					<li><input class="btn btn-info"
						style="width: 100%; margin-top: 3px" type="button" value="약국 찾기"
						onclick="location.href='<c:url value='/Homespital/Map.hst'/>'" /></li>
				</ul>
			</div>
			<!-- 3번째 줄 -->
			<div class="homeFaqSec col-md-7">
				<h3>
					<img src="https://ssl.nx.com/S2/membership/2011/home/stit_faq.gif"
						width="77" height="14" alt="자주묻는질문" />
				</h3>
				<ul class="faqBest5">
					<li class="faqList1 on">
						<h4>
							<a href="#" name="faqService">내정보</a>
						</h4>
						<div class="faqBest5List">
							<p>
								고객님께서 자주 찾으시는 질문 <strong>Best5</strong>를 모았습니다.
							</p>
							<ol>
								<li><a href=""><span>1</span>[내 질병 관리] ?????????</a></li>
								<li><a href=""><span>2</span> [회원탈퇴] 기존ID 회원탈퇴를 하고
										싶어요.</a></li>
								<li><a href=""><span>3</span> [회원가입] ID는 몇 개나 만들 수
										있나요?</a></li>
								<li><a href=""><span>4</span> [회원탈퇴] 이메일ID 회원탈퇴를 하고
										싶어요.</a></li>
			...
			<div class='col-md-3'>
				<ul class="list-unstyled4" style="height: 100%">
					<li><input class="btn btn-info"
						style="width: 100%; height: 50%" type="button" value='회원정보 변경'
						onclick="location.href='<c:url value='/mypage/ChangeMember.hst'/>'" /></li>
					<li><input class="btn btn-info"
						style="width: 100%; height: 50%; margin-top: 5px" type="button"
						value="비밀번호 변경"
