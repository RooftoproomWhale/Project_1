...
<style>
 ...
 margin-left:130px;
  ...
  /*현재페이지*/
  .sidebar-nav :nth-child(6) a{ color: #fff;background: #B2EBF4; }
  		...
  		<section id="contents"> <!-- /////////////////////////////////// Contents [S] -->
				...
				<input type="hidden" name="mode" value="delete"/>
					...
					<div class="board-util">
						<div class="board-util-right">
							<button type="button" class="btn btn-primary" role="button" onclick="Form();"><span class="button-text">회원탈퇴</span></button>
