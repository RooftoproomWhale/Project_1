...
DROP TABLE ROAD_ADDR CASCADE CONSTRAINTS;
...
(
	HOSCODE number NOT NULL,
	HOSP_NAME nvarchar2(20) NOT NULL,
	AUTHORIZED number DEFAULT -1 NOT NULL,
	TEL number NOT NULL,
	WEEKDAY_TIME varchar2(20) NOT NULL,
	WEEKEND_TIME varchar2(20) NOT NULL,
	LOC_CODE number NOT NULL,
	ROAD_CODE number NOT NULL,
	ADDRESS nvarchar2(100) NOT NULL,
	PRIMARY KEY (HOSCODE)
);
...
(
	PHAR_CODE number NOT NULL,
	PHAR_NAME nvarchar2(30) NOT NULL,
	TEL number NOT NULL,
	WEEKDAY_TIME varchar2(20) NOT NULL,
	HOLIDAY_TIME varchar2(20) NOT NULL,
	LOC_CODE number NOT NULL,
	ROAD_CODE number NOT NULL,
...
CREATE TABLE ROAD_ADDR
(
	ROAD_CODE number NOT NULL,
	ROAD_NAME nvarchar2(20) NOT NULL,
...
ALTER TABLE HOS_DEPT
	ADD FOREIGN KEY (HOSCODE)
	REFERENCES HOSPITAL (HOSCODE)
;
...
ALTER TABLE HOSPITAL
	ADD FOREIGN KEY (ROAD_CODE)
	REFERENCES ROAD_ADDR (ROAD_CODE)
;
